...
class PelatihController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Pelatih::whereHas('ekskuls', function ($q) use ($ekskulTampil) {
        ...
        return view('pembina.pelatih.index', compact('pelatih', 'adaEkskulTanpaPembina', 'ekskulList', 'filterEkskul'));
    }
