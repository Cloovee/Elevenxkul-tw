...
<div class="bg-white rounded-3xl shadow-[0_10px_30px_-18px_rgba(46,43,85,0.35)] border border-ink/5 p-8 max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h3 class="text-xl font-display font-bold text-[#2E2B55]">Tambah Data Siswa</h3>
    </div>
    ...
    <form action="{{ route('admin.siswa.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" name="NISN" class="w-full px-4 py-2.5 bg-[#F3F4FC] border-none rounded-xl text-sm text-[#2E2B55] focus:ring-2 focus:ring-[#9FA1FF] @error('NISN') ring-2 ring-red-400 @enderror" value="{{ old('NISN') }}" required>
            ...
            <div>
                ...
                <input type="text" name="NIS" class="w-full px-4 py-2.5 bg-[#F3F4FC] border-none rounded-xl text-sm text-[#2E2B55] focus:ring-2 focus:ring-[#9FA1FF] @error('NIS') ring-2 ring-red-400 @enderror" value="{{ old('NIS') }}" required>
            ...
            <div>
                ...
                <input type="text" name="nama_siswa" class="w-full px-4 py-2.5 bg-[#F3F4FC] border-none rounded-xl text-sm text-[#2E2B55] focus:ring-2 focus:ring-[#9FA1FF] @error('nama_siswa') ring-2 ring-red-400 @enderror" value="{{ old('nama_siswa') }}" required>
