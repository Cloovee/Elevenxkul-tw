...
<div class="bg-white rounded-[1.5rem] shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] border border-gray-50 p-8 max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h3 class="text-xl font-extrabold text-[#2b3674]">Tambah Data Siswa</h3>
    </div>
    ...
    <form action="{{ route('admin.siswa.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" name="NISN" class="w-full px-4 py-2.5 bg-[#f4f7fe] border-none rounded-xl text-sm text-[#2b3674] focus:ring-2 focus:ring-[#868dfb] @error('NISN') ring-2 ring-red-400 @enderror" value="{{ old('NISN') }}" required>
            ...
            <div>
                ...
                <input type="text" name="NIS" class="w-full px-4 py-2.5 bg-[#f4f7fe] border-none rounded-xl text-sm text-[#2b3674] focus:ring-2 focus:ring-[#868dfb] @error('NIS') ring-2 ring-red-400 @enderror" value="{{ old('NIS') }}" required>
            ...
            <div>
                ...
                <input type="text" name="nama_siswa" class="w-full px-4 py-2.5 bg-[#f4f7fe] border-none rounded-xl text-sm text-[#2b3674] focus:ring-2 focus:ring-[#868dfb] @error('nama_siswa') ring-2 ring-red-400 @enderror" value="{{ old('nama_siswa') }}" required>
