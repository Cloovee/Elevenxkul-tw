...
<div class="bg-white rounded-3xl shadow-[0_10px_30px_-18px_rgba(46,43,85,0.35)] border border-ink/5 p-8 max-w-lg mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h3 class="text-xl font-display font-bold text-[#2E2B55]">Tambah Kelas</h3>
    </div>
    ...
    <form action="{{ route('admin.kelas.store') }}" method="POST">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="tingkat" placeholder="Contoh: X" class="w-full px-4 py-2.5 bg-[#F3F4FC] border-none rounded-xl text-sm text-[#2E2B55] focus:ring-2 focus:ring-[#9FA1FF] @error('tingkat') ring-2 ring-red-400 @enderror" value="{{ old('tingkat') }}" required>
        ...
        <div class="mb-5">
            ...
            <input type="text" name="jurusan" placeholder="Contoh: IPA" class="w-full px-4 py-2.5 bg-[#F3F4FC] border-none rounded-xl text-sm text-[#2E2B55] focus:ring-2 focus:ring-[#9FA1FF] @error('jurusan') ring-2 ring-red-400 @enderror" value="{{ old('jurusan') }}" required>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="rombel" placeholder="Contoh: 10" class="w-full px-4 py-2.5 bg-[#F3F4FC] border-none rounded-xl text-sm text-[#2E2B55] focus:ring-2 focus:ring-[#9FA1FF] @error('rombel') ring-2 ring-red-400 @enderror" value="{{ old('rombel') }}" required>
