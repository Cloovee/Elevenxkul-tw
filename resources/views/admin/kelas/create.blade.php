...
<div class="bg-white rounded-3xl shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] border border-gray-50 p-8 max-w-lg mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h3 class="text-xl font-extrabold text-[#10316B]">Tambah Kelas</h3>
    </div>
    ...
    <form action="{{ route('admin.kelas.store') }}" method="POST">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="jurusan" placeholder="Contoh: IPA" class="w-full px-4 py-2.5 bg-[#F2F7FF] border-none rounded-xl text-sm text-[#10316B] focus:ring-2 focus:ring-[#0B409C] @error('jurusan') ring-2 ring-red-400 @enderror" value="{{ old('jurusan') }}" required>
