...
<div class="bg-white rounded-[1.5rem] shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] border border-gray-50 p-8 max-w-lg mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h3 class="text-xl font-extrabold text-[#2b3674]">Tambah Kelas</h3>
    </div>
    ...
    <form action="{{ route('admin.kelas.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="rombel" placeholder="Contoh: 10" class="w-full px-4 py-2.5 bg-[#f4f7fe] border-none rounded-xl text-sm text-[#2b3674] focus:ring-2 focus:ring-[#868dfb] @error('rombel') ring-2 ring-red-400 @enderror" value="{{ old('rombel') }}" required>
