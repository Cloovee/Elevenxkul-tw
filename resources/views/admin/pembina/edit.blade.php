        ...
        <div class="mb-6">
            ...
            <div class="flex items-center gap-4">
                <div class="relative w-16 h-16 shrink-0">
                    @if($pembina->foto_url)
                        <img id="foto-preview" src="{{ $pembina->foto_url }}" class="w-16 h-16 rounded-2xl object-cover border border-[#DDE8FB]" alt="Foto saat ini">
                    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="alamat" id="alamat" rows="3"
                    class="w-full px-4 py-2 border border-[#DDE8FB] rounded-xl focus:ring-2 focus:ring-lavender focus:border-transparent">{{ old('alamat', $pembina->alamat) }}</textarea>
            </div>
        </div>
