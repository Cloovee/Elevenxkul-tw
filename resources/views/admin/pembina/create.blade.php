        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="password" name="password" id="password"
                    class="w-full px-4 py-2 border border-[#EDEDFF] rounded-xl focus:ring-2 focus:ring-lavender focus:border-transparent @error('password') border-red-500 @enderror">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="alamat" id="alamat" rows="3"
                    class="w-full px-4 py-2 border border-[#EDEDFF] rounded-xl focus:ring-2 focus:ring-lavender focus:border-transparent">{{ old('alamat') }}</textarea>
            </div>
        </div>
