            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div class="flex-1 space-y-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-display font-bold text-ink">Absensi Pelatih</h1>
                        <p class="text-sm text-inksoft mt-1">Catat apakah pelatih hadir/melatih hari ini. Laporan akan divalidasi oleh pembina ekskul terkait.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('ketua.absensi-pelatih.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="bg-gradient-to-br from-white to-periwinkle/10 rounded-3xl shadow-xl shadow-periwinkle/10 ring-1 ring-black/5 p-6">
                            <h2 class="font-semibold text-ink border-b border-ink/10 pb-3 mb-4">Foto Bukti Absensi (opsional)</h2>
                        ...
                        <div class="bg-gradient-to-br from-white to-sky/10 rounded-3xl shadow-xl shadow-sky/10 ring-1 ring-black/5 p-6">
                            <h2 class="font-semibold text-ink border-b border-ink/10 pb-3 mb-4">Data Absensi</h2>

                            <div class="space-y-4">
                                <div>
                                    <label class="block text-sm font-medium text-ink mb-1.5">Pelatih</label>
