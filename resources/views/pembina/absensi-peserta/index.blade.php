                    ...
                    @foreach ($riwayatPerEkskul as $i => $item)
                        ...
                        <div class="border border-[#EFEFF7] rounded-2xl overflow-hidden">
                            ...
                            <button type="button"
                                    ...
                                    class="w-full flex items-center justify-between gap-4 px-4 py-3.5 text-left bg-[#FBF4EC] hover:bg-[#F6ECDF] transition-colors">
                            ...
                            <div class="sm:hidden flex items-center justify-between px-4 py-2 bg-[#FBF4EC] text-xs text-inksoft border-t border-white/60">
                                    ...
                                    <div x-data="{ openTanggal: false }" class="border-t border-[#F5F5FA]">
                                        <button type="button" @click="openTanggal = !openTanggal"
                                            ...
                                            <span class="flex items-center gap-3 shrink-0">
                                                <span class="text-[11px] font-bold px-2.5 py-1 rounded-full bg-mint text-[#1F7A3D]">{{ $sesiItem['hadir'] }}/{{ $sesiItem['total'] }} hadir</span>
