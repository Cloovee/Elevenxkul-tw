...
<div id="delete-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-[#10316B]/40 backdrop-blur-sm px-4">
    <div class="bg-white rounded-3xl p-6 w-full max-w-sm shadow-[0_20px_50px_-20px_rgba(46,43,85,0.45)]">
        ...
        <div class="flex gap-3">
            <button type="button" id="delete-modal-cancel"
                    class="flex-1 py-2.5 rounded-xl border border-[#DDE8FB] font-semibold text-sm text-inksoft hover:bg-bgsoft">Batal</button>
