...
<body class="font-body antialiased bg-bgsoft text-ink">
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-10 min-h-screen relative overflow-hidden">
        ...
        @if (session('success'))
            <div class="prof-in flex items-start gap-3 bg-emerald-50 text-emerald-700 text-sm font-semibold px-4 py-3 rounded-2xl" style="--d:0ms">
            ...
            <div class="flex items-center gap-3 bg-white rounded-2xl pl-3.5 pr-5 py-2.5 shadow-[0_10px_30px_-18px_rgba(46,43,85,0.35)]">
                <div class="relative w-10 h-10 shrink-0">
                    <svg viewBox="0 0 36 36" class="w-10 h-10 -rotate-90">
                        <circle cx="18" cy="18" r="15.5" fill="none" stroke="#E8F0FE" stroke-width="4"></circle>
            ...
            <div class="order-2 lg:order-1 w-full lg:mr-[380px] flex flex-col gap-5">
                ...
                <div class="prof-in bg-white rounded-3xl p-7 shadow-[0_10px_30px_-18px_rgba(46,43,85,0.35)]" style="--d:60ms">
                    <div class="flex items-center gap-3 mb-5">
                        <div class="w-10 h-10 rounded-2xl bg-periwinkle/30 text-[#10316B] flex items-center justify-center shrink-0">
                    ...
                    <form method="POST" action="{{ route('pembina.profile.update') }}" class="flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative" style="position:relative;">
                                    ...
                                    <input type="text" name="nomor_hp" placeholder="08xx-xxxx-xxxx" value="{{ old('nomor_hp', $pembina->nomor_hp ?? '') }}"
                                           class="field-input w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-[#DDE8FB] text-sm focus:border-lavender focus:ring-2 focus:ring-lavender/15 transition-colors" style="padding-left:40px; padding-right:14px;">
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="flex items-center justify-between mt-1 pt-4 border-t border-[#E8F0FE]">
                            <p class="text-xs text-inksoft">Perubahan tersimpan otomatis ke akunmu.</p>
                            <button type="submit"
                                    class="bg-lavender text-white font-bold text-sm px-6 py-2.5 rounded-xl hover:opacity-90 hover:-translate-y-0.5 transition-all shrink-0">
                                Simpan Perubahan
                            </button>
                        </div>
                    </form>
                    ...
                    <div class="flex flex-col items-center text-center px-8 pt-8 pb-8">
                        ...
                        <div class="relative w-28 h-28 mb-3 block" style="position:relative;">
                            <div class="relative w-full h-full">
                                <div id="foto-preview-fallback" class="w-full h-full rounded-full border-4 border-white shadow-[0_10px_30px_-12px_rgba(46,43,85,0.4)] bg-lavender flex items-center justify-center {{ $pembina?->foto_url ? 'hidden' : '' }}">
                        ...
                        <span class="inline-flex items-center gap-1.5 mt-2 px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-[11px] font-bold">
                        ...
                        <div class="w-full mt-6 pt-6 border-t border-[#E8F0FE] flex flex-col gap-3 text-left">
                            ...
                            <div class="flex items-center gap-3 bg-bgsoft rounded-2xl px-4 py-3">
                                <div class="w-8 h-8 rounded-xl bg-sky text-[#0B409C] flex items-center justify-center shrink-0">
                            ...
                            <div class="flex items-center gap-3 bg-bgsoft rounded-2xl px-4 py-3">
                                <div class="w-8 h-8 rounded-xl bg-periwinkle/40 text-[#10316B] flex items-center justify-center shrink-0">
