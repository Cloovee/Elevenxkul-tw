...
<body class="font-body antialiased bg-bgsoft text-ink">
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-10 min-h-screen relative overflow-hidden">
        ...
        {{-- HERO --}}
        <div class="animate-fade-in-up rounded-3xl p-7 bg-[#D9F9DF] shadow-[0_10px_30px_-18px_rgba(30,168,111,0.35)] relative overflow-hidden">
        ...
        <div class="animate-fade-in-up animate-delay-1 bg-white rounded-3xl shadow-[0_10px_30px_-18px_rgba(46,43,85,0.35)] p-6">
            ...
            <div class="flex flex-wrap justify-between items-center gap-4 mb-5">
                <form method="GET" class="flex flex-wrap items-center gap-2">
                    ...
                    <button type="submit" class="px-4 py-2 bg-bgsoft hover:bg-[#DDE8FB] text-ink rounded-full text-sm font-bold transition-colors">
                        Cari
                    </button>
                    @if(request('search'))
                        <a href="{{ route('pembina.pelatih.index') }}" class="px-4 py-2 bg-bgsoft hover:bg-[#DDE8FB] text-inksoft rounded-full text-sm font-bold transition-colors">
                            Reset
                        </a>
                    @endif
                </form>
                ...
                <a href="{{ route('pembina.pelatih.create') }}"
                   class="inline-flex items-center gap-2 px-4 py-2 bg-[#57C785] text-white rounded-full text-sm font-bold shadow-md shadow-[#57C785]/30 hover:opacity-90 transition-opacity">
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-bgsoft/60 transition-colors">
                            ...
                            <td class="px-3 py-3">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 rounded-full bg-emerald-50 text-emerald-700 flex items-center justify-center font-extrabold text-sm flex-shrink-0">
                                        {{ $initial }}
                                    </div>
                            ...
                            <td class="px-3 py-3 whitespace-nowrap">
                                @forelse($p->ekskuls as $e)
                                    <span class="inline-block px-2 py-1 rounded-full text-[10px] font-bold bg-periwinkle/20 text-[#10316B] mr-1">{{ $e->nama_ekskul }}</span>
                                @empty
